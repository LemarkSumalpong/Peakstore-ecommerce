        ...
        <div className="text-center">
          ...
          <form className="flex w-full max-w-sm mx-auto">
            <input
              ...
              className="flex-grow px-4 py-3 rounded-l-md shadow-md bg-white text-black focus:outline-none"
            />
            <button
              type="submit"
              className="bg-blue-600 text-white px-5 py-3 rounded-r-md hover:bg-blue-500 transition"
            >
              Submit
            </button>
          </form>
